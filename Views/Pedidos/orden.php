    ...
    <div class="col-md-12">
      <div class="tile">
        ...
        <section id="sPedido" class="invoice">
          <div class="row mb-4">
            <div class="col-6">
              <h2 class="page-header"><img src="<?= media(); ?>/tienda/images/logodark.png" style="width: 200px; height: 60px;"></h2>
            </div>
            <div class="col-6">
              ...
              <table class="table table-striped">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td class="text-right"><?= SMONEY.' '. formatMoney($servicio['cantidad'] * $servicio['precio']) ?></td>
                  </tr>
                  <?php 
                            }
                        }
